...
"""
Adapted from SAMed and LoRA-SAM
"""
...
class LoRA_Sam(nn.Module):
    ...
    def forward(self, image, box, freeze_img=False, out_shape=(512,512)):
        # do not compute gradients for prompt encoder
        # Image: (1,3,1024,1024)
        # print(box)
        # print("image", image.shape, "box", box.shape if box is not None else None, "freeze_img", freeze_img)
        if not freeze_img:
        ...
        with torch.no_grad():
            ...
            if box is not None:
              ...
              # print("box shape", box_torch.shape)
            ...
            # print("sparse, dense shape", sparse_embeddings.shape, dense_embeddings.shape, self.sam.prompt_encoder.get_dense_pe().shape)
        # print("img emb shape", image_embedding.shape)
        low_res_logits, iou_predictions = self.sam.mask_decoder(
            ...
            multimask_output=True, # print 4 masks, including background
        )
